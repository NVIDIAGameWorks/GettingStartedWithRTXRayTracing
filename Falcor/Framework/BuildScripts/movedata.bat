...
SET CommonSourceDirectory=%2\CommonPasses\

rem echo "%ExternalsSourceDirectory%"
rem echo "%DestinationDirectory%"
...
call %1\BuildScripts\moveprojectdata.bat %1\Source\ %DestinationDirectory% /r:0 > nul
call %1\BuildScripts\moveprojectdata.bat %3 %DestinationDirectory% /r:0 > nul
call %1\BuildScripts\moveprojectdata.bat %CommonSourceDirectory% %DestinationDirectory% /r:0 > nul
